...
const About: Component = () => (
  <div class="min-h-screen bg-black text-white font-sans selection:bg-blue-500/30">
    <header class="border-b border-neutral-900 sticky top-0 bg-black/80 backdrop-blur-md z-50">
      <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-6">
          <A href="/about" class="text-sm font-medium text-white">About</A>
    ...
    <main class="max-w-4xl mx-auto px-6 py-24">
      <section class="mb-16">
        <h1 class="text-4xl md:text-5xl font-light tracking-tight mb-8">About Malfestio</h1>
        <p class="text-xl text-neutral-400 font-light leading-relaxed mb-6">
          Malfestio is a decentralized learning platform built on the AT Protocol. We believe knowledge should be
          portable, shareable, and owned by learners — not locked into proprietary platforms.
        </p>
        <p class="text-lg text-neutral-500 font-light leading-relaxed">
          By combining spaced repetition, linked notes, and social features with decentralized identity and data
          ownership, we're creating a new way to learn and share knowledge across the open web.
        </p>
      </section>

      <section class="mb-16">
        <h2 class="text-2xl font-light mb-6 text-white">Team</h2>
        <div class="border border-neutral-800 p-6 bg-neutral-900/50">
          <div class="flex items-center gap-4 mb-4">
            <div class="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center text-white font-semibold">
              O
            </div>
            <div>
              <h3 class="text-lg font-medium text-white">Owais</h3>
              <p class="text-sm text-neutral-400">
                <a
                  href="https://desertthunder.dev"
                  target="_blank"
      ...
      <section>
        <h2 class="text-2xl font-light mb-6 text-white">Links</h2>
        <div class="flex flex-col gap-4">
          <a
            href="https://tangled.org/desertthunder.dev/malfestio"
            target="_blank"
            rel="noopener noreferrer"
            class="flex items-center gap-3 text-neutral-400 hover:text-white transition-colors group">
            <svg
          ...
          <a
            ...
            rel="noopener noreferrer"
            class="flex items-center gap-3 text-neutral-400 hover:text-white transition-colors group">
            <span class="i-bi-github text-lg group-hover:text-blue-400" />
